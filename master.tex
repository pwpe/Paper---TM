...
\title{Effects of Patient Empowerment in a Telehealth for Chronic Obstructive Pulmonary Disease Patients}
...
\keywords{
	telehealth; COPD; feedback;
}

\input{introduction}
\input{background}
\input{background_patientempowerment}
\input{background_healthliteracy}
\input{background_cds}
